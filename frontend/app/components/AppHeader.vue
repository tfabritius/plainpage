...
<template>
  <div class="flex items-center py-1">
    ...
    <ULink to="/" :active="false" class="text-xl font-light flex items-center whitespace-nowrap shrink-0">
      <!-- favicon -->
    ...
    >
      <template #content>
        <div class="flex items-center gap-2 p-3">
          ...
          <UIcon name="tabler:search" class="w-5 h-5 text-muted shrink-0" aria-hidden="true" />
          <input
            id="search-input"
            ref="searchInputRef"
            v-model="searchQuery"
            ...
            class="flex-1 bg-transparent border-none outline-none text-base text-default placeholder:text-muted"
